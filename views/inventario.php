...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['accion'])) {
    ...
    if ($_POST['accion'] === 'crear') {
        ...
        $controller->crearProducto(
            ...
            $_POST['stock_actual'],
            $_POST['stock_minimo'],
            $_POST['precio_costo_bob'],
            $_POST['precio_venta_publico_bob']
        );
    ...
    } elseif ($_POST['accion'] === 'crear_marca') {

        $stmt = $db_conn->prepare("
            INSERT INTO marcas_productos
            (nombre_marca,pais_origen,procedencia)
            VALUES
            (:nombre,:pais,:procedencia)
        ");
    ...
    } elseif ($_POST['accion'] === 'crear_proveedor') {

        $stmt = $db_conn->prepare("
            INSERT INTO proveedores
            (razon_social,nit,telefono,contacto_vendedor)
            VALUES
            (:razon,:nit,:telefono,:contacto)
        ");
        ...
        $stmt->execute([
            ...
            ':contacto'=>$_POST['contacto_vendedor']
        ]);
...
<div id="modalNuevo" class="CAPA-MODAL">
    ...
    <button
        type="button"
        onclick="abrirModal('modalProveedor')"
        style="float:right;">
        +
    </button>
</label>
...
<div id="modalCategoria" class="CAPA-MODAL">
    <div class="VENTANA-MODAL">

        <div class="MODAL-HEADER">
            <h3>Nueva Categoría</h3>
            <button class="MODAL-CERRAR" onclick="cerrarModal('modalCategoria')">
                &times;
            </button>
        </div>
...
<div id="modalMarca" class="CAPA-MODAL">
    <div class="VENTANA-MODAL">

        <div class="MODAL-HEADER">
            <h3>Nueva Marca</h3>
            <button class="MODAL-CERRAR" onclick="cerrarModal('modalMarca')">
                &times;
            </button>
        </div>
...
<div id="modalProveedor" class="CAPA-MODAL">
    <div class="VENTANA-MODAL">
        ...
        <div class="MODAL-HEADER">
            ...
            <button
                class="MODAL-CERRAR"
                onclick="cerrarModal('modalProveedor')">
