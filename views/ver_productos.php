...
$query = "SELECT id_producto, nombre_producto, precio_venta_publico_bob, stock_actual FROM productos";
    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="./../views/ver_productos.php" class="active">Productos</a></li>
...
<div class="contenedor-productos">
    ...
    while ($producto = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        $precioVenta = $producto['precio_venta_publico_bob'];
        $stock       = $producto['stock_actual'];

        // Definimos la ruta base por defecto por si acaso no hay ninguna foto
        $rutaFinal = "./../public/img/img_productos/default.png"; 

        // PHP revisa en orden cuál de los archivos existe físicamente en tu carpeta img/
        if (file_exists("./../public/img/img_productos/$idProd.webp")) {
            $rutaFinal = "./../public/img/img_productos/$idProd.webp";
        } elseif (file_exists("./../public/img/img_productos/$idProd.jpg")) {
            $rutaFinal = "./../public/img/img_productos/$idProd.jpg";
        } elseif (file_exists("./../public/img/img_productos/$idProd.jpeg")) { 
            $rutaFinal = "./../public/img/img_productos/$idProd.jpeg";
        } elseif (file_exists("./../public/img/img_productos/$idProd.png")) {  
            $rutaFinal = "./../public/img/img_productos/$idProd.png";
        }
        ?>

        <div class="tarjeta-producto">
            <div class="contenedor-img">
                <img src="<?php echo $rutaFinal; ?>" alt="<?php echo $nombreProd; ?>" class="imagen-producto">
            </div>
            <h3><?php echo $nombreProd; ?></h3>
            <p class="precio"><?php echo $precioVenta; ?> BOB</p>
